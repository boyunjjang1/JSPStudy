...
<!-- 회원 가입창에서 전송된 동일한 이름의 매개변수에 해당되는 유즈빈 속성에 전송된 값 설정 -->
...
<jsp:setProperty name="m" property="emial" value='<%= request.getParameter("emial") %>' />

<%
	// 자바코드를 이용해 더이상 빈에 설정할 필요가 없어짐!!
	/*
		String id = request.getParameter("id");
		String pwd = request.getParameter("pwd");
		String name = request.getParameter("name");
		String emial = request.getParamter("emial");
